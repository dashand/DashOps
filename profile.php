<?php
// profile.php
// Page de gestion de profil (changement de mot de passe)
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark mb-4">
        <div class="container-fluid">
            <a class="navbar-brand" href="index.php">IELO Dashboard</a>
            <div class="d-flex align-items-center">
                <span class="text-light me-3">Bonjour, <?= htmlspecialchars(getCurrentUser()) ?></span>
                <a href="index.php" class="btn btn-outline-light btn-sm me-2">Retour au tableau</a>
